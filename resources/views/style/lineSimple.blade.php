...
<div class="card">
    <div class="card-body">
        <div class="card-title"><h4>Sequential Analysis</h4> <span>First Style Number Take as Reference</span></div>
        <div class="container mt-5">
            
            <form id="inputForm" action="{{ route('style.lineSimpleAnalysis') }}" method="get">
                @csrf
                <div class="row">
                    <div class="col-8">
